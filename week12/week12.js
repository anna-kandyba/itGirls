...
const makeSixteen = () => {
  const str = "JavaScript";
  resultSixteen.innerText = str.substring(5);
  //Ваш код
};
...
const makeNineteen = () => {
  const str = "Hello, world!";
  resultNineteen.innerText = str.substring(7, 13);
  //Ваш код
};
...
const makeTwentyOne = () => {
  resultTwentyOne.innerText = Math.random(1, 10);
...
const makeTwentySix = () => {
  ...
  resultTwentySix.innerText = random.toFixed(4);
  //Ваш код
};
...
const makeTwentySeven = () => {
  ...
  resultTwentySeven.innerText = Math.round(random);
  //Ваш код
};
