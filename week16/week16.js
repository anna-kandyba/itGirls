...
function makeTwo() {
  ...
  console.log(firstForm.getAttribute("name"));
}
...
function makeThree() {
  ...
  console.log(lastForm.getAttribute("name"));
}
...
function makeFive() {
  ...
  console.log(thirdForm.elements.length);
}
...
function makeSix() {
  ...
  console.log(twoForm.elements.length);
}
...
function makeSeven() {
  ...
  const colection = secondForm.elements;
  let elementsList = "";
  ...
  const span = document.getElementById("practicum7");
  span.textContent = elementsList;
}
...
function makeEight() {
  ...
  const firstName = document.forms[0];
...
function makeTen() {
  ...
  for (const element of form.elements) {
    if (element.type === "radio" && element.checked) {
      paragraphTen.textContent = element.value;
      break;
    }
  }
  console.log(paragraphTen.textContent);
}
...
function makeEleven() {
  ...
  const elem = form.elements.select;
  let optionsValues = "";
  for
}
